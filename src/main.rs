...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let menu_titles = vec!["Home", "Pets", "Add", "Delete", "Timers", "Quit"];
    ...
    loop {
        terminal.draw(|rect| {
            ...
            let copyright = Paragraph::new("work-timers-CLI - all rights reserved")
        ...
        match rx.recv()? {
            Event::Input(event) => match event.code {
                ...
                KeyCode::Char('t') => active_menu_item = MenuItem::Timers,
                KeyCode::Char('a') => {
